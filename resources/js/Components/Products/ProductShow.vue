...
<template>
  ...
  >
    ...
    >
    <img
      class="hidden size-full object-cover object-center md:block lg:hidden"
      :src="imgSrcTablet"
    >
    <img
      class="hidden size-full object-cover object-center lg:block"
      :src="imgSrcDesktop"
    >

    <div
      class="flex flex-col gap-6 md:gap-4 md:px-14 lg:items-start lg:self-center lg:px-0 lg:text-left"
    >
      ...
      <h2
        class="w-full text-3xl font-bold uppercase text-black md:pb-2 md:text-4xl"
      >
